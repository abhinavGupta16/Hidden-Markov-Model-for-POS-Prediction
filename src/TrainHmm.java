...
public class TrainHmm {
    ...
    public static void main(String[] args) throws Exception{
        ...
        File file = new File(BASE_DIR + "WSJ_02-21.pos");
...
//        print2DArray(trainHmm.stateState, trainHmm.stateIndexMap, trainHmm.stateIndexMap);
        ...
        File fileTest = new File(BASE_DIR + "WSJ_24.words");
        File filePos = new File(BASE_DIR + "test.pos");
        trainHmm.processFile(fileTest, filePos);

        System.out.println("Score");
        Score.main(new String[]{BASE_DIR + "WSJ_24.pos", filePos.getPath()});
    }
