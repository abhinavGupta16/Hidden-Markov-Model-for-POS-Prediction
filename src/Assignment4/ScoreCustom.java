...
public class ScoreCustom {
    ...
    public static void main (String[] args) throws IOException {
        ...
        int correct = 0;
        int incorrect = 0;
        File fileMismatchPos = new File("D:\\NYU_assignment\\Spring_2020\\NLP\\NLP\\src\\Assignment4\\Files\\test_mismatch.pos");
        ...
        for (int i = 0; i < key.size(); i++) {
            ...
            if (responsePos.equals(keyPos)) {
                ...
                fileMismatchPosBr.write(responseFields[0] + " " + keyPos + " " + responsePos + "\n");
                incorrect = incorrect + 1;
            }
        }
        fileMismatchPosBr.close();
